...
/*TODO List
    ...
    -Permitir y probar valores de fechas por debajo del día (horas, minutos, segundos).
    -Hacer que el aspect ratio se calcule respecto a una resolución o tamaño de pantalla bien por defecto o bien indicado por parámetro, de modo
        que si se carga la página en un navegador minimizado, o con una resolución de pantalla menor, se ajuste automáticamente a los valores
        correspondientes, en lugar de tomar el valor actual por bueno y redimensionar si crece. Esto facilitaría el trabajo del programador, que
        sólo tendría que preocuparse de definir la gráfica para una resolución de pantalla y ésta se redimensionaría para los demás casos.
